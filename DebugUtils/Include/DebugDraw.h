...
inline constexpr unsigned int duRGBA(int r, int g, int b, int a)
{
	return ((unsigned int)r) | ((unsigned int)g << 8) | ((unsigned int)b << 16) | ((unsigned int)a << 24);
}

inline constexpr unsigned int duRGBAf(float fr, float fg, float fb, float fa)
{
...
inline constexpr unsigned int duDarkenCol(unsigned int col)
{
	return ((col >> 1) & 0x007f7f7f) | (col & 0xff000000);
}

inline constexpr unsigned int duLerpCol(unsigned int ca, unsigned int cb, unsigned int u)
{
...
inline constexpr unsigned int duTransCol(unsigned int c, unsigned int a)
{
